...
# for local use of the package
# DEFAULT_MODEL_DIRECTORY = Path(os.getcwd()) / "cache" / "gpt4all"
# to use the package in a jupyter notebook locally
DEFAULT_MODEL_DIRECTORY = Path(os.getenv('GPT4ALL_CACHE_DIR', os.getcwd())) / "cache" / "gpt4all"
